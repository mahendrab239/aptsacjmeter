    ...
    try:
        ...
        if TestUrl.startswith('http'):
            ...
            if configtype == defaultConfig:
                LitehouseArgs = "--chrome-flags='--headless --disable-gpu --disable-dev-shm-usage --no-sandbox' --config-path=/report/lighthouse-mobile-config.js --extra-headers=/report/Lighthouse-headers.json --output=json --output=html"
            else:
                LitehouseArgs = "--chrome-flags='--headless --disable-gpu --disable-dev-shm-usage --no-sandbox' --config-path=/report/lighthouse-desktop-config.js --extra-headers=/report/Lighthouse-headers.json --output=json --output=html"
